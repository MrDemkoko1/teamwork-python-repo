class Farm:
    ...
    def __str__(self):
        return f"Location: {self.__location}, Animals: {self.__animals_qty}, Amount of milk: {self.__amount_of_milk}, Fan Power: {self.__vent_power}W"

    def __repr__(self):
        return f"Farm(location='{self.__location}', num_animals={self.__animals_qty}, amount_of_milk={self.__amount_of_milk}, fan_power={self.__vent_power})"
